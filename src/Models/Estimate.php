...
class Estimate extends Model
{
    ...
    {
        return $this->hasMany('Rutatiina\Estimate\Models\EstimateComment', 'estimate_id')->latest();
    }
    ...
    {
        return $this->hasMany('Rutatiina\Estimate\Models\EstimateItemTax', 'estimate_id', 'id');
    }
