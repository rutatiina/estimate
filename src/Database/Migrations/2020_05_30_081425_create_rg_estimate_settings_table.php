...
class CreateRgEstimateSettingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('tenant')->create('rg_estimate_settings', function (Blueprint $table) {
    ...
    {
        Schema::connection('tenant')->dropIfExists('rg_estimate_settings');
    }
}
