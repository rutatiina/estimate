        ...
        <div class="page-header page-header-light d-print-none">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title d-flex">
                    <h4><i class="icon-files-empty2 mr-2"></i> <span class="font-weight-semibold">Estimate</span></h4>
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                ...
                <div class="header-elements">
                    <div class="breadcrumb justify-content-center">
                        ...
                        <div class="btn-group mr-2" v-if="!this.$root.loadingTxn && txnData">
                            <button type="button"
                                    class="btn btn-sm dropdown-toggle btn-warning border-warning border-2 font-weight-bold"
                                    data-toggle="dropdown">
                                <i class="icon-cog mr-1"></i> Process to </button>
                            <div class="dropdown-menu dropdown-menu-right">
                                <router-link :to="'/estimates/'+txnData.id+'/process/invoice'" class="dropdown-item"><i class="icon-files-empty2"></i> Invoice</router-link>
                                <div class="dropdown-divider"></div>
                                <router-link :to="'/estimates/'+txnData.id+'/process/retainer-invoices'" class="dropdown-item"><i class="icon-files-empty2"></i> Retainer Invoice</router-link>
                                <router-link :to="'/estimates/'+txnData.id+'/process/sales-orders'" class="dropdown-item"><i class="icon-files-empty2"></i> Sales Order</router-link>
                                <router-link :to="'/estimates/'+txnData.id+'/process/recurring-invoices'" class="dropdown-item"><i class="icon-files-empty2"></i> Recurring Invoice</router-link>
                            </div>
                        </div>
                    ...
                    <div class="card-header header-elements-inline d-print-none text-danger">
                        ...
                        <div class="header-elements">
                            <button type="button"
                                    ...
                                    @click="txnApprove('/estimates/'+txnData.id+'/approve')"><i class="icon-file-check2 mr-2"></i> Click here to Approve</button>

                            <router-link :to="'/estimates/'+$route.params.id+'/edit'"
                ...
                <div class="card max-width-960 m-auto rg-print-border-0">
                    ...
                    <div class="card-header bg-transparent header-elements-inline d-print-none">
                        ...
                        <div class="header-elements">
                            ...
                            <router-link :to="'/estimates/'+$route.params.id+'/copy'"
                            ...
                            <a :href="'/estimates/'+$route.params.id+'/pdf'" type="button" class="btn btn-light btn-sm ml-1"><i class="icon-file-pdf mr-2"></i>Pdf</a>
                                ...
                                <div class="mb-4">
                                    <div class="text-sm-right">
                                        <h4 class="text-primary mb-2 mt-md-2">
                                            <span class="text-uppercase">{{txnData.document_name}}</span>
                                            #{{txnData.number_string}}
                                        </h4>
                                        <ul class="list list-unstyled mb-0">
